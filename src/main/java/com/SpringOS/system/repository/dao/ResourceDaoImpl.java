...
public class ResourceDaoImpl implements ResourceDao {
    ...
    public Resource createResource(final Resource resource) {
        final String sql = "insert into os_resource(name, type, url, permission, parent_id, parent_ids, available) values(?,?,?,?,?,?,?)";
    ...
    public Resource updateResource(Resource resource) {
        final String sql = "update os_resource set name=?, type=?, url=?, permission=?, parent_id=?, parent_ids=?, available=? where id=?";
        jdbcTemplate.update(
                sql,
    ...
    public void deleteResource(Long resourceId) {
        ...
        final String deleteSelfSql = "delete from os_resource where id=?";
        jdbcTemplate.update(deleteSelfSql, resourceId);
        final String deleteDescendantsSql = "delete from os_resource where parent_ids like ?";
    ...
    public Resource findOne(Long resourceId) {
        final String sql = "select id, name, type, url, permission, parent_id, parent_ids, available from os_resource where id=?";
    ...
    public List<Resource> findAll() {
        final String sql = "select id, name, type, url, permission, parent_id, parent_ids, available from os_resource order by concat(parent_ids, id) asc";
